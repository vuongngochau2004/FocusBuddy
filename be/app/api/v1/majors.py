...
from app.schemas.module_1_user_management.major import MajorCreate, MajorUpdate, MajorResponse, MajorListResponse
from app.services.module_1_user_management.major_service import MajorService
