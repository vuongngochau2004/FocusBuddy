...
def create_grade(
    ...
    return service.create_grade(str(user_id), data)
...
def get_grades(
    ...
    return service.get_grades(str(user_id), course_id=course_id, term_id=term_id, skip=skip, limit=limit)
...
def get_grade(
    ...
    return service.get_grade(str(user_id), id)
...
def update_grade(
    ...
    return service.update_grade(str(user_id), id, data)
...
def delete_grade(
    ...
    service.delete_grade(str(user_id), id)
...
def import_grades(
    ...
    return service.import_grades(str(user_id), data)
